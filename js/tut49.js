...
regex = /number \d+/ // \d+ means more than one non digit
...
regex = /\Ska number/ // \s+ means match one or more than one whitespace characters
regex = /\S+ka number/; // Match one or more than one non whitespace character
regex = /bhai\b/;  // word boundary

// Assertions
regex = /h(?=y)/;
regex = /h(?!y)/;

let str = "harh7rd1r4r5ry%%$@bhai hdrryska number 899999harry9999";
