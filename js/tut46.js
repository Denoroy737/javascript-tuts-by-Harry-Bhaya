...
let reg = /Tena/; // This is a regular expression literal in js
reg = /Tena/g; // g means global
// reg = /Tena/i; // i means case insensitive

// console.log(reg);
// console.log(reg.source);

let s = "This is great code with Tena and also Tena bhai";
